...
export function AgentControlBar({
  ...
  return (
    <div
      ...
      className={cn(
        'bg-background flex flex-col rounded-[31px] border border-gray-600 p-3 drop-shadow-md/3',
        className
      )}
      {...props}
    >
      <div className="flex flex-row justify-between gap-1 rounded-4xl border bg-[#2d2d2d] p-3">
        ...
        {/* <p className="animate-text-shimmer inline-block !bg-clip-text p-2 text-sm font-semibold text-transparent">
          Meeting in progress...
        </p> */}
        <Logo />
