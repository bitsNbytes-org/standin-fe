...
export function MediaTiles() {
  ...
  return (
    <div className="pointer-events-none mx-auto mt-10 size-4">
        ...
        <div className={cn(classNames.grid)}>
          ...
          <div
            className={cn([
              ...
              classNames.agentChatClosed,
              hasSecondTile && classNames.agentChatOpenWithSecondTile,
              !hasSecondTile && classNames.agentChatOpenWithoutSecondTile,
            ])}
          >
            <AnimatePresence mode="popLayout">
              ...
              {isAvatar && (
                ...
                <MotionAvatarTile
                  ...
                  videoTrack={agentVideoTrack}
                  className={cn('h-[60px] [&>video]:h-[60px] [&>video]:w-auto')}
                />
              )}
            </AnimatePresence>
          </div>
          ...
          <div
            className={cn(['grid', classNames.secondTileChatOpen, classNames.secondTileChatClosed])}
          >
            {/* camera */}
            <AnimatePresence>
